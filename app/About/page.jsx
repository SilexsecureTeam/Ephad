      ...
      >
        ...
        <section className="grid items-center justify-center pt-10  pb-4 w-full text-center">
          ...
          <p className="text-sm sm:text-base md:text-xl font-normal roboto max-w-[90%] mx-auto pb-2">
            ...
            are committed to bridging the technology gap by providing top-tier
        ...
        <section className="border-t-7  border-t-[#E3EBFF] w-full mb-6 pt-4">
          ...
          <div className="text-lg md:text-xl lg:text-2xl leading-normal lg:leading-[30px] text-[#333333] mx-auto py-6 lg:py-10">
            <p>
              ...
              join us in creating a vibrant and dynamic learning environment
              where every student can thrive. Let us work hand in hand to
              inspire, challenge, and support our students as they grow into
              confident, capable, and caring individuals. <br />
              <br />
        ...
        <section className="border-t-7 border-t-[#E3EBFF] w-full mb-6 pt-4">
          ...
          <div className="flex flex-col lg:flex-row gap-6 w-full">
            <div className="text-lg md:text-xl lg:text-2xl leading-normal lg:leading-[30px] text-[#333333] py-6 lg:py-10 lg:w-3/5">
              <p>
                The director of Epad ICT Academy is a trailblazer in the field
                of information and communication technology, with a passion for
                ...
                the director has been instrumental in shaping the academy's
                vision of creating a tech-savvy community. <br />
                <br />
                Under their leadership, Epad ICT Academy has emerged as a
                leading institution, recognized for its commitment to
                excellence, innovation, and community impact. The director's
                dedication to bridging the digital divide and promoting lifelong
                learning has transformed the academy into a beacon of
                opportunity for learners of all backgrounds. <br />
                <br />
                Through their forward-thinking approach and unwavering
                commitment to excellence, the director continues to drive Epad
                ICT Academy's mission of equipping individuals with the skills
                to navigate and excel in the digital era.
              </p>
            </div>
